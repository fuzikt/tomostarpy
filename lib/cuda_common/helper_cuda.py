# adapted form https://github.com/NVIDIA/cuda-python/blob/main/examples/common/helper_cuda.py
...
from lib.cuda_common.helper_string import getCmdLineArgumentInt, checkCmdLineFlag
